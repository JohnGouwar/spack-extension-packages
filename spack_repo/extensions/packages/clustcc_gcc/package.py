...
class ClustccGcc(Package, CompilerPackage):
    ...
    def install(self, spec, prefix):
        ...
        clustcc_client = spec["clustcc-client"].prefix.bin.clustcc_client
        wrapped_c_script = f'#!/bin/sh\n{clustcc_client} {real_c_compiler} "$@"'
        wrapped_cxx_script = f'#!/bin/sh\n{clustcc_client} {real_cxx_compiler} "$@"'
