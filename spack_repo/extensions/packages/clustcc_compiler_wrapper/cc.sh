...
execute() {
    ...
    # args to the client will be clustcc_client mode cwd FULL_COMMAND
    prepend full_command_list "$(pwd)"
    prepend full_command_list "${mode}"
    prepend full_command_list "clustcc_client"
